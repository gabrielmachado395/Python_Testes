...
Green 2 -> Criar o código e ver o teste passar
...
class TestBaconComOvos(unittest.TestCase):
    def test_bacon_com_ovos_deve_retornar_assertion_error_se_nao_receber_int(self):
    ...
    def test_bacon_com_ovos_deve_retornar_fome_se_entrada_não_for_multiplo_de_3_e_5(self):
        entradas = (1, 2, 4, 7, 8)
        saida = 'Fome'
